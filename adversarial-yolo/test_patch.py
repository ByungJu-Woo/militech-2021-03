...
if __name__ == '__main__':
    ...
    imgdir = "/content/drive/MyDrive/custom_model_training/inria_person_data/inria/Test/pos"
    cfgfile = "/content/drive/MyDrive/adversarial-yolo/cfg/yolov2.cfg"
    weightfile = "/content/drive/MyDrive/adversarial-yolo/weights/yolo.weight"
    patchfile = "/content/drive/MyDrive/adversarial-yolo/test_patches/patches/marpat_patch_new2_36.jpg"
    ...
    savedir = "/content/drive/MyDrive/adversarial-yolo/test_patches/"
    ...
    for imgfile in os.listdir(imgdir):
        ...
        if imgfile.endswith('.jpg') or imgfile.endswith('.png'):
            ...
            resize = transforms.Resize((img_size,img_size)) #608
            ...
            boxes = do_detect(darknet_model, padded_img, 0.4, 0.4, True) #0.4, 0.4
            print(len(boxes))
            boxes = nms(boxes, 0.4)
            print(len(boxes))
